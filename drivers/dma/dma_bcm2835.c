 ...
 * (PER_MAP from dma_slot, plus the S/D_DREQ bits) but are first
 * exercised by the I2S driver. 2D mode, chained CBs, and the careful
 * mid-transfer paused-abort dance Linux performs are not implemented.
 *
