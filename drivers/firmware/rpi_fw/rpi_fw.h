...
/** @name Power and domain tags */
/** @{ */
/** @brief Get power state */
#define RPI_FW_TAG_GET_POWER_STATE    0x00020001U
/** @brief Set power state */
#define	RPI_FW_TAG_SET_POWER_STATE    0x00028001U
/** @brief Get domain state */
#define RPI_FW_TAG_GET_DOMAIN_STATE   0x00030030U
/** @brief Set domain state */
#define RPI_FW_TAG_SET_DOMAIN_STATE   0x00038030U
/** @} */
