 ...
 *
 * The dispatch logic is a near-line-for-line port of Linux's
 * drivers/irqchip/irq-bcm2835.c (get_next_armctrl_hwirq), including
 * the three quirks documented there:
 *
...
/* IRQ_BASIC_PENDING register layout, mirroring Linux's irq-bcm2835.c */
...
/*
 * Shortcut table from Linux's irq-bcm2835.c. Indices 0..4 hold the
 * bank-1 IRQ numbers reachable via bank-0 bits 10..14; indices 5..10
 * hold the bank-2 IRQ numbers reachable via bank-0 bits 15..20.
 */
