 ...
 *
 * BCM2835 reuses the BCM2711 GPIO/pinmux model (GPFSEL function select,
 * GPPUD pulls), so the pinctrl pin type and init macros are identical.
 */

#ifndef ZEPHYR_SOC_ARM_BCM2835_PINCTRL_SOC_H_
#define ZEPHYR_SOC_ARM_BCM2835_PINCTRL_SOC_H_
...
#endif /* ZEPHYR_SOC_ARM_BCM2835_PINCTRL_SOC_H_ */
