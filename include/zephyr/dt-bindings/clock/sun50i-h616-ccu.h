...
/*
 * Zephyr-local IDs, not present in the mainline binding. Direct
 * handles on the video PLLs for bring-up and debug; normal consumers
 * set the leaf clock (tcon-tv0, hdmi) and the driver programs the
 * parent PLL itself.
 */
