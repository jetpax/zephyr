 ...
 *
 * The bank-shift encoding matches Linux's irq-bcm2835.c MAKE_HWIRQ
 * (offset by +32 for the L1 reservation) so the shortcut/cascade
 * decode in the SoC layer can be a near-line-for-line port of that
 * driver's get_next_armctrl_hwirq.
 */
